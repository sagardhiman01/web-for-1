...
// Lightweight health check for load balancers / uptime probes
...
Route::post('/chatbot/message', 'ChatbotController@message')->name('chatbot.message')->middleware('throttle:chatbot');
...
Route::controller('SiteController')->group(function () {
    ...
    Route::post('/contact', 'contactSubmit')->middleware('throttle:contact');

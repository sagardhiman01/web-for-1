                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="referral"
                                                   value="{{ old('referral', session()->get('reference')) }}" pattern="\d{6}" maxlength="6" inputmode="numeric">
                                            <small class="text-muted">@lang('Enter 6-digit referral code if you have one')</small>
                                        </div>
                                    </div>

...
<body style="background-image: url(https://perview.freelancerawais.online/cyclepro/core/css/static/images/new/backaa2.png); background-size: cover; height: 100%;">
    <div>
        ...
        <form method="POST" action="{{route ('user.register')}}" id="signupForm" class="signin-form px-4">
            ...
            <div class="search mt-4">
                <input placeholder="6-digit Invitation Code" type="text" name="referral" class="no-arrow ps-3" value="{{ old('referral', session()->get('reference')) }}" pattern="\d{6}" maxlength="6" inputmode="numeric" style="padding-top: 14px;">

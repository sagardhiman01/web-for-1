...
@section('panel')
    @php
        $gatewayParameters = json_decode($method->gateway_parameters ?? '{}', true) ?? [];
        $qrImage = $gatewayParameters['qr_image'] ?? null;
    @endphp
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea rows="8" class="form-control border-radius-5" name="instruction">{{ old('instruction', @$method->description) }}</textarea>
                                                </div>
                                                <div class="form-group mt-3">
                                                    <label>@lang('Deposit QR Code (Optional)')</label>
                                                    <input type="file" class="form-control" name="qr_image" accept=".jpg,.jpeg,.png,.webp,image/*">
                                                    <small class="text-muted">@lang('Upload a QR image for this deposit method')</small>
                                                    @if($qrImage)
                                                        <div class="mt-2">
                                                            <img src="{{ getImage('assets/images/manual_gateway/' . $qrImage) }}" alt="Deposit QR" style="max-width: 220px;" class="img-thumbnail">
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>

    ...
    */
    ...
    protected function validator(array $data)
    {
        ...
        $validate = Validator::make($data, [
            ...
            'reference' => \App\Models\User::count() > 0 ? 'nullable|digits:6|exists:users,referral_code' : 'nullable|digits:6',
            'referral' => \App\Models\User::count() > 0 ? 'nullable|digits:6|exists:users,referral_code' : 'nullable|digits:6',
    ...
    protected function create(array $data)
    {
        ...
        $referBy = trim((string) ($data['reference'] ?? $data['referral'] ?? ''));
        if (preg_match('/^\d{6}$/', $referBy)) {

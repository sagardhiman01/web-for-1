                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap gap-3 justify-content-between align-items-center">
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <input type="text" id="currencySearch" class="form-control" placeholder="@lang('Search by name or symbol')">
                                    <button type="button" class="btn--base btn-sm" id="refreshCurrencyBtn">
                ...
                <div class="col-lg-5 mb-4">
                    <div class="card custom--card h-100">
                        <div class="card-body p-0">
                            <div class="table-responsive--md currency-table-wrapper">
...
@push('style')
    <style>
        ...
        .currency-row.active {
            background: rgba(204, 163, 84, 0.14);
        }

...
<input type="text" value="{{ route('home') }}?ref={{ auth()->user()->referral_code }}" id="myInput">
</div>

	
		<div style="display:none;">
<input type="text" value="{{ auth()->user()->referral_code }}" id="myInpu">
</div>
...
function outFunc() {
  ...
  tooltip.innerHTML = "Copy to clipboard";
        ...
        <div class="header-img-text2 ps-5 row m-0 p-0 w-100 justify-content-center">
            ...
            <div class="col-6 p-0 pt-2">
                <h5 class="w-100 p-2 px-2" id="referal_link"
                    ...
                    {{ route('home') }}?ref={{ auth()->user()->referral_code }}
                </h5>
            </div>
    ...
    <div class="mx-2 mt-4 p-3 team-level">
        <h5 class="mb-3" style="font-size: 15px; font-weight: 700; color: #000000;">Direct Referral Details</h5>
        <div class="table-responsive">
            <table class="table table-striped align-middle mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center">No referred users found</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>

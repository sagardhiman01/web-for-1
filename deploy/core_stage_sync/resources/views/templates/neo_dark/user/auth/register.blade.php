                    ...
                    <div class="signin-form-area">
                        ...
                        <form class="signin-form verify-gcaptcha" action="{{ route('user.register') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="referral" placeholder="@lang('6-digit referral code')" value="{{ old('referral', session()->get('reference')) }}" pattern="\d{6}" maxlength="6" inputmode="numeric">
                                <small class="text-muted">@lang('Auto-filled when you open site from a referral link. Referral code is 6 digits.')</small>
                            </div>

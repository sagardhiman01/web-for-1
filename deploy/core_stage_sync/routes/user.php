...
Route::namespace('User\Auth')->name('user.')->group(function () {
    ...
    Route::controller('RegisterController')->group(function(){
        Route::get('register', 'showRegistrationForm')->name('register')->middleware('referral');
        Route::post('register', 'register')->middleware(['registration.status','referral','throttle:register']);
        Route::post('check-mail', 'checkUser')->name('checkUser')->middleware('throttle:register');
    });
        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            ...
            Route::controller('WithdrawController')->prefix('withdraw')->name('withdraw')->group(function(){
                Route::middleware('kyc')->group(function(){
                    ...
                    Route::post('address', 'updateWithdrawAddress')->name('.address.update');
                    Route::post('save-address', 'saveWithdrawAddress')->name('.save.address');

...
<body>
    <div class="text-center pt-4">
        <span style="font-size:16px; font-weight: 500; color: #000000; font-family: Gotham;">Recharge Record</span>
    </div>
    <div class="container">
           @forelse($deposits as $deposit)
                ...
                <div class="recharge-plan mt-3 px-4">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <span class="sub-heading pe-2">{{ showAmount($deposit->amount) }} {{ $general->cur_text }}</span>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="date_time ">
                            <span class="sub-heading pe-2">{{ showDateTime($deposit->created_at, 'M d Y @g:i:a') }}</span>
                        </div>
                    </div>
                </div>
                <div>

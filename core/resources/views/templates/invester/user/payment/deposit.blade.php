...
<body class="main-layout">
  ...
  <div class="">
    <!-- <div class="p-3 row m-0 p-0 " id="header-card"> -->
      <!-- <div class="col-8"> -->
        <h2 class="recharge-label m-3 ">Recharge</h2>
      <!-- </div> -->
    ...
    <div class="header-img-container mx-3 mt-2">
      ...
      <div class="text-end mt-2">     
        <a href="{{route ('user.deposit.history')}}" class="icon-overley">
    ...
    <div class="form-group mx-3">
      <div class="form-group">
        ...
        <label for="holder-name" class="ms-2">Enter recharge amount</label>
        </div>
    ...
    <div class="d-flex justify-content-center">
      ...
      <button class="register-button text_align_center mt-2 px-4 w-75" type="submit" >Recharge</button>
    </div>
